      ...
      <div className="relative flex h-full max-h-[1080px] w-full max-w-[1920px] flex-col items-center justify-center gap-2">
        <div className="relative mx-auto flex h-[250px] w-full max-w-[1200px] items-center justify-center md:size-[80%]">
          {!isCurrentImageLoaded && (
            <div className="absolute inset-0 flex items-center justify-center bg-transparent">
              <div className="h-10 w-10 animate-spin rounded-full border-4 border-icon border-t-transparent"></div>
            </div>
          )}
          <img
        ...
        <div className="flex items-center justify-center gap-6">
          <button
            ...
            className="flex size-fit items-center justify-center rounded-full bg-icon/90 p-2 text-white shadow-md transition-colors duration-200 hover:bg-icon focus:outline-none focus:ring-2 focus:ring-secondary-200 md:absolute md:left-4 md:top-1/2 md:-translate-y-1/2"
          ...
          <button
            ...
            className="flex size-fit items-center justify-center rounded-full bg-icon/90 p-2 text-white shadow-md transition-colors duration-200 hover:bg-icon focus:outline-none focus:ring-2 focus:ring-secondary-200 md:absolute md:right-4 md:top-1/2 md:-translate-y-1/2"
        ...
        <div
          className="absolute bottom-4 right-4 rounded-full bg-black/40 px-3 py-1 text-sm text-white backdrop-blur-sm"
          ref={(el) => (clickableRefs.current[4] = el)}
        >
